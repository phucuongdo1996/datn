        ...
        <form action="" id="form-data-profile">
            ...
            <table class="table table-bordered">
                    ...
                    <td>
                        ...
                        @foreach($specialties as $value)
                            <label class="container-input fs14 fw-bold width-fit-content">
                                <input type="checkbox" class="pointer profile-setting checkbox-specialty cus-checkbox progress-calculate-checkbox" value="{{ $value['id'] }}" name="specialty[]"
                    ...
                    <td>
                        <div class="row p20l">
                            ...
                            <div class="col-9 col-md-4 p0l">
                                <input type="text" name="person_charge_last_name" class="form-control fs13 profile-setting progress-calculate" value="{{ $profile['person_charge_last_name'] }}"
                            ...
                            <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                <input type="text" name="person_charge_first_name" class="form-control fs13 profile-setting progress-calculate" value="{{ $profile['person_charge_first_name'] }}"
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l p0r">
                                <input type="text" name="email" value="{{ $profile['email'] }}" class="form-control col-10 fs13 profile-setting progress-calculate">
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <textarea name="introduction" class="form-control col-11 profile-setting not-required progress-calculate" rows="7">{{ $profile['introduction'] }}</textarea>
