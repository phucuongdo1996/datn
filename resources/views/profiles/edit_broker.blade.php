            ...
            <table class="table table-bordered">
                    ...
                    <td>
                        ...
                        @foreach($specialties as $value)
                            <label class="container-input fs14 fw-bold width-fit-content">
                                <input type="checkbox" class="pointer checkbox-specialty cus-checkbox progress-calculate-checkbox" value="{{ $value['id'] }}" name="specialty[]"
                    ...
                    <td>
                        <div class="row p20l">
                            ...
                            <div class="col-9 col-md-4 p0l">
                                <input type="text" name="person_charge_last_name" class="form-control error-color fs13 progress-calculate" value="{{ $profile['person_charge_last_name'] ?? '' }}"
                            ...
                            <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                <input type="text" name="person_charge_first_name" class="form-control error-color fs13 progress-calculate" value="{{ $profile['person_charge_first_name'] ?? '' }}"
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l p0r input-md-pr">
                                <input type="text" name="email" value="{{ $profile['email'] ?? '' }}" class="form-control col-11 col-md-10 fs13 progress-calculate">
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l ">
                            <div class="col-md-12 p0l p0r input-md-pr">
                                <input type="text" name="business_name" class="form-control col-11 col-md-10 fs13 not-required progress-calculate" value="{{ $profile['business_name'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l p0r input-md-pr">
                                <input type="text" name="website_business_name" class="form-control col-11 col-md-10 fs13 not-required progress-calculate" value="{{ $profile['website_business_name'] ?? '' }}"
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-10 col-md-5 p0l p0r">
                                <input type="text" name="company_name" class="form-control fs13 progress-calculate" value="{{ $profile['company_name'] ?? '' }}"
                            ...
                            <div class="col-10 col-md-5 p0l p0r">
                                <input type="text" name="division" class="form-control fs13 progress-calculate" value="{{ $profile['division'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            ...
                            <div class="col-9 col-md-4 p0l">
                                <input type="text" class="form-control fs13 progress-calculate" name="company_representative_last_name" value="{{ $profile['company_representative_last_name'] ?? '' }}"
                                       placeholder="{{ __('attributes.profile.body.place_holder.last_name') }}">
                                <p class="error-message p5t m0" data-error="company_representative_last_name"></p>
                            </div>
                            <label class="col-2 col-md-1 text-left text-md-center lh3 p0">{{ __('attributes.profile.body.content.first_name') }}</label>
                            <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                <input type="text" class="form-control fs13 progress-calculate" name="company_representative_first_name" value="{{ $profile['company_representative_first_name'] ?? '' }}"
                                       placeholder="{{ __('attributes.profile.body.place_holder.first_name') }}">
                    ...
                    <td>
                        <div class="row p20l p30r row-license">
                            ...
                            <div class="col-5 col-md-2 p0l p0r">
                                <input type="text" name="license" maxlength="2" class="form-control fs13 progress-calculate" value="{{ $profile['license'] ?? '' }}">
                            ...
                            <div class="col-8 col-md-2 p0l p0r">
                                <input type="text" name="number_license" maxlength="6" class="form-control fs13 progress-calculate" placeholder="" value="{{ $profile['number_license'] ?? '' }}">
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l">
                                <input type="text" name="phone" class="form-control col-11 col-md-6 fs13 progress-calculate" value="{{ $profile['phone'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l">
                                <input type="text" name="zip_code" class="form-control col-11 col-md-6 fs13 zip-code progress-calculate" value="{{ $profile['zip_code'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l">
                                <input type="text" name="address_district" class="form-control col-11 col-md-6 fs13 progress-calculate" value="{{ $profile['address_district'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <input type="text" name="address_town" class="form-control col-11 fs13 progress-calculate" value="{{ $profile['address_town'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <input type="text" name="address_building" class="form-control col-11 fs13 not-required progress-calculate" value="{{ $profile['address_building'] ?? '' }}"
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-md-12 p0l p0r">
                                <input type="text" name="website_business_name_other" class="form-control col-11 fs13 not-required progress-calculate" value="{{ $profile['website_business_name_other'] ?? '' }}"
                ...
                <tr>
                    ...
                    <td>
                        <div class="row p20l">
                            <textarea name="introduction" class="form-control col-11 not-required progress-calculate" rows="7">{{ $profile['introduction'] ?? '' }}</textarea>
