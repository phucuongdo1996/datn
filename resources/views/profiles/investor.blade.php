                    ...
                    <td>
                        <div class="row p20l">
                            ...
                            <div class="col-9 col-md-4 p0l">
                                <input type="text" name="person_charge_last_name" class="form-control fs13 progress-calculate"
                            ...
                            <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                <input type="text" name="person_charge_first_name" class="form-control fs13 progress-calculate"
                    ...
                    <td>
                        <div class="row p20l">
                            <select name="gender" class="form-control col-10 col-md-2 m5b fs13 progress-calculate">
                                <option value="0">{{ __('attributes.common.male') }}</option>
                                <option value="1">{{ __('attributes.common.female') }}</option>
                            </select>
                            ...
                            <div class="col-10 col-md-3 p0l p0r">
                                <input type="text" name="birthday" id="date-picker" class="form-control fs13 progress-calculate" value="1980/01/01">
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-10 col-md-8 p0l p0r">
                                <input type="text" name="email" value="{{ $currentUser->email }}" class="form-control fs13 progress-calculate">
                            </div>
                    ...
                    <td>
                        <div class="row p20l">
                            <div class="col-10 col-md-5 p0l p0r">
                                <input type="text" name="company_name" class="form-control fs13 not-required progress-calculate"
                                       placeholder="{{ __('attributes.profile.body.place_holder.company') }}">
                                <p class="error-message p5t m0" data-error="company_name"></p>
                            </div>
                            <span class="col-10 col-md-1 d-none d-md-block text-center fs20">/</span>
                            <div class="col-10 col-md-5 p0l p0r">
                                <input type="text" name="division" class="form-control fs13 not-required progress-calculate"
                    ...
                    <div class="row p20l">
                        <div class="col-12 col-md-4 p0l">
                            <label class="container-input p30l">
                                <input type="radio" name="notification" value="0" checked class="input-notification">
                        ...
                        <div class="col-12 col-md-4 p0l">
                            <label class="container-input p30l">
                                <input type="radio" name="notification" value="1" class="input-notification">
                                <span class="checkmark-radio"></span>
