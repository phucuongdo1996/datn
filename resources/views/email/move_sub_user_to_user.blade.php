...
<br>
<div>{{ trans('mail-attributes.admin_move_sub_user.content_to') }}</div>
<div>{{ trans('mail-attributes.admin_move_sub_user.content_to_2').$data['person_charge_last_name_from'].$data['person_charge_first_name_from'] }}</div>
<div>{{ trans('mail-attributes.admin_move_sub_user.content_to_3') }}</div>
