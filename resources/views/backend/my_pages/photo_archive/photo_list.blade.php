    ...
    <div class="container-fluid container-wrapper container-wrapper-bank wrapper-bank-list">
        <div id="main-info-assessment">
            ...
            <div class="d-flex col-8 text-center text-lg-right m0 p0">
                @if($currentUser && $userProfile->profile->user_id == $currentUser->id)
                    <div class="w-auto text-center text-md-right m0 ml-auto p0">
                        ...
                        <ul class="dropdown-menu list-house-tax m15t fs14">
                            ...
                            @endif
                            <li class="p5"><a href="{{ route(USER_ARTICLE_TEXT_ADD, ['id' => $currentUser->id, 'screen' => 'photos']) }}" class="parent-checkbox" data-value="" tabIndex="-1">{{ trans('attributes.my_page.btn_default.new_topics') }}</a></li>
                            ...
                            <li class="p5"><a href="{{ route(USER_ARTICLE_PHOTO_CREATE, ['id' => $currentUser->id, 'screen' => 'photos']) }}" class="parent-checkbox" data-value="" tabIndex="-1">{{ trans('attributes.my_page.btn_default.new_photo_archive') }}</a></li>
                            ...
                            <div class="user_photo_wrap mp_r">
                                ...
                                <div class="row photo_article fs15">
                                    @forelse($articlePhotos as $articlePhoto)
                                        <a class="photo_article_item photo_article_item_edit col-4" data-toggle="modal" data-target=".photo-{{ $articlePhoto['id'] }}" data-keyboard="true" data-backdrop="true">
                                            <div class="img">
                                            ...
                                            <div class="txt caption-image d-none break-all">{{ $articlePhoto->caption }}</div>
                                        </a>
                                    @empty
            ...
            <div class="d-flex col-8 text-center text-lg-right m0 p0">
                @if(empty($currentUser) || $userProfile->profile->user_id != $currentUser->id)
                    <div class="w-auto text-center text-md-right m0 ml-auto p0">
                        <a href="#" class="btn custom-btn-primary fs15 sort-property m0 p18l p18r w-auto">{{ trans('attributes.my_page.chat') }}</a>
                        <a href="#" class="btn custom-btn-primary fs15 sort-property m0 p18l p18r w-auto">{{ trans('attributes.my_page.inquiry') }}</a>
                    </div>
