                        ...
                        <div class="col-3 p0 p10r">
                            <div class="row m-0">
                                <table class="table table-bordered table-preview table-preview-analysis tb-pre-1 m-0 m10b">
                                    <tbody>
                                    <tr>
                                        <td class="text-center fw-normal" id="destination-bank-print" colspan="3"></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <table class="table table-bordered table-preview table-preview-analysis tb-pre-1 m-0 m10b">
                            ...
                            <div class="row m-0">
                                <table class="table table-bordered table-preview table-preview-analysis tb-pre-1 m-0 m10b">
                                    ...
                                    <tr>
                                        ...
                                        <td class="preview-input-date text-center">{{ $businessPlan['input_date'] ? dateTimeFormat($businessPlan['input_date']) : ""  }}</td>
                                    </tr>
                                    </tbody>
                                </table>
