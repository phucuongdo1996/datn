        ...
        <form id="main-info-assessment">
            ...
            <div class="row row-header m50b">
                <div class="row m0">
                    <div class="col-12 text-center text-md-left p0">
                        <h3 class="m0">{{ __('attributes.rent_roll.title_contract_renewal') }}</h3>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row m0 p0">
                            <div class="col-6 d-flex p0 p10r align-items-center">
                                ...
                                <div class="w-40 col-12-sp p0">
                                    <div class="w-100">
                                        <input name="floor_code" type="text" value="{{$data['floor_code']}}" class="form-control m0 p13 p8l p8r h-auto fs14 text-left" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="btn wrap-input w230 p0 br4">
                                        <select name="real_estate_type_id" class="option-paginate-1 btn form-control hp100 p3 fs14">
                                            ...
                                            @for($i = FLAG_ONE; $i < FLAG_TEN; $i++)
                                                <option value="{{$i}}"
                                                @if($data['real_estate_type_id'] === $i)
                                                    {{ 'selected' }}
                                                @endif
                                                >{{ REAL_ESTATE_TYPE[$i] }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="d-flex col-12 text-center text-lg-right m0 p0">
                ...
                <div class="w-auto text-center text-md-right m0 p0">
                    <button type="button" id="contract-renewal-rent-roll" class="btn custom-btn-primary fs15 m0 p18l p18r w-auto">{{ __('attributes.rent_roll.btn_save') }}</button>
                </div>
            </div>
        </form>
    </div>
