...
<div class="container-fluid container-wrapper container-padding container-wrapper-add">
    <form id="form-data-repair-history" action=" {{ route(USER_REPAIR_HISTORY_STORE, ['propertyId' => $property->id]) }}" method="POST">
        @csrf
                ...
                <div class="m0 diagram-analysis">
                    <div class="p30 diagram-block">
                        <div class="d-flex m30b m0l">
                            <p class="fs16 fw-bold m0">{{ trans('attributes.repair_history.add.title') }}</p>
                        </div>
                                ...
                                <div class="w-auto m20r">
                                    <div class="btn wrap-input-option-copy w230 p0 br4 @error('classify') input-error @enderror">
                                        <select name="classify" class="option-paginate-1 btn form-control hp100 p3 p15r p15l fs14">
                                            <option value="" {{ old('classify')=='' ? 'selected' : ''  }}>---</option>
                        ...
                        <div class="row m-0 m15t p0">
                            ...
                            <div class="w-70 col-12-sp p0">
                                <div class="w-100 m20r">
                                    <textarea name="describe" id="items" cols="15" rows="5" class="form-control m0 p13 p15l p15r h-auto fs14 text-left">{{ old('describe') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row m-0 m15t p0">
                            ...
                            <div class="w-70 col-12-sp p0">
                                <div class="w230 m20r">
                                    <input type="text" name="order_repair_date" value="{{ old('order_repair_date') }}"
                        ...
                        <div class="row m-0 m15t p0">
                            ...
                            <div class="w-70 col-12-sp p0">
                                <div class="w230 m20r">
                                    <input type="text" name="construction_completion_date" value="{{ old('construction_completion_date') }}"
                            ...
                            <div class="w-70 col-12-sp p0">
                                <div class="row m0">
                                    <div class="col-10 p0 mw230">
                                        <input type="text" name="payment_excluding_tax" value="{{ old('payment_excluding_tax') ?? 0 }}"
                                               class="form-control m0 p13 p8l p8r h-auto fs14 text-left convert-data @error('payment_excluding_tax') input-error @enderror"
                        ...
                        <div class="row m-0 m15t p0">
                            ...
                            <div class="w-70 col-12-sp p0">
                                <div class="w230 m20r">
                                    <input type="text" name="payment_side" value="{{ old('payment_side') }}" class="form-control m0 p13 p8l p8r h-auto fs14 text-left" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex col-12 text-center text-lg-right m0 p0">
                ...
                <div class="w-auto text-center text-md-right m0 p0">
                    <button type="submit" class="p0 border-0 m0 w-auto btn-update-repair">
                        <a class="btn custom-btn-primary fs15 sort-property m0 p18l p18r w-auto btn-add-repair">{{ trans('attributes.repair_history.add.btn_add') }}</a>
                    </button>
                </div>
            </div>
        </div>
