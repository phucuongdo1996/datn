...
@section('content')
    <div class="content-wrapper">
                ...
                <div id="main-info-assessment">
                    ...
                    <div id="form-condition-1" class="row m0 m30b">
                        <div class="col-12 col-xl-6 text-center text-md-right m0 p0 group-status-top row">
                            <div id="block-status" class="row spBlock ml-0 m20r w-auto">
                        ...
                        <div class="col-12 col-xl-6 col-12-sp text-center text-lg-right p0 text-right group-button-top">
                            <button type="button" class="add-business-plan btn custom-btn-primary fs15 sort-property m15r w70">{{ trans('attributes.sort_table.btn-save') }}</button>
                                ...
                                <div class="m0 m30b diagram-analysisu">
                                    <div class="col-12 p30 diagram-block">
                                        ...
                                        <div class="row m-0 p0">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="row col-12 m0 p0">
                                                    <input name="input_date" value="" class="form-control m0 p5 p10l p10r w-100 h-auto fs14 text-center date-time" />
                                        ...
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="col-12 p0">
                                                    <input type="hidden" value="{{ $property['loan_bank_name'] .' '.$property['bank_branch_name'] }}" class="loan-bank-name">
                                                    <input name="destination_bank" id="destination-bank" value="" class="destination-bank form-control m0 p5 p10l p10r w-100 h-auto fs14" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="col-12 p0">
                                                    <input name="destination_address" value="{{ addressFormat($profile['address_city'], $profile['address_district'], $profile['address_town'], $profile['address_building']) }}" class="form-control p6 p10l p10r h-auto fs14" id="destination-address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="col-12 p0">
                                                    <input name="destination_name" value="{{ nameFormat($profile['person_charge_last_name'] ,$profile['person_charge_first_name']) }}" class="form-control p6 p10l p10r h-auto fs14" id="destination-name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="col-12 p0">
                                                    <input name="material_creator_name" value="" class="material-creator-name form-control m0 p5 p10l p10r w-100 h-auto fs14">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="m0 diagram-analysisu">
                                    <div class="col-12 p30 diagram-block">
                                        <div class="row m-0 p0">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="row col-12 m0 p0">
                                                    <input name="expected_borrowing_date" id="expected-borrowing-date" value="{{ $property['loan_date'] ? date("Y/m/d", strtotime($property['loan_date'])) : '' }}" class="form-control m0 p5 p10l p10r w-100 h-auto fs14 text-center date-time" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0">
                                                <div class="col-12 p0">
                                                    <input name="expected_borrowing_amount" id="expected-borrowing-amount" value="{{ $property['loan'] }}" class="expected-borrowing-amount form-control m0 p5 p10l p10r w-100 h-auto fs14 text-right convert-data" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-9 offset-3 p0">
                                        ...
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0 d-flex">
                                                <div class="col-11 p0">
                                                    <input name="initial_borrowing_period" id="initial-borrowing-period" value="{{ $property['contract_loan_period'] }}" class="convert-data initial-borrowing-period form-control m0 p5 p10l p10r w-100 h-auto fs14 text-center">
                                                </div>
                                        ...
                                        <div class="row m-0 p0 p15t">
                                            ...
                                            <div class="col-9 col-12-sp p0 d-flex">
                                                <div class="col-11 p0">
                                                    <input name="expected_interest" id="expected-interest" value="{{ $property['interest_rate'] }}" class="convert-number-double-decimal expected-interest form-control m0 p5 p10l p10r w-100 h-auto fs14 text-center">
                                                </div>
                                                <div class="col-1 w-8 p0 p8t text-right">
                                ...
                                <div class="p0 m0">
                                    ...
                                    <div class="col-12 p0">
                                        <dl class="m30b">
                                            ...
                                            <dd class="m0">
                                                <input name="date_of_confirmation" id="date-of-confirmation" value="" placeholder="{{ trans('attributes.business_plan.plan_3') }}" class="form-control m0 p5 p10l p10r w-100 h-auto fs14 text-left" />
                                            </dd>
                                        </dl>
                                        <dl class="m30b">
                                            <dt class="m10b p3b border-bottom fs15">{{ trans('attributes.business_plan.plan_4') }}</dt>
                                            <dd class="m0">
													<textarea name="note_confirmation_procedure" id="note-confirmation-procedure" cols="15" rows="5" class="form-control m0 h-auto fs14 text-left">{{ trans('attributes.business_plan.plan_5') }}</textarea>
                                            </dd>
                                        </dl>
                                        <dl class="m30b">
                                        ...
                                        <dl class="m0">
                                            ...
                                            <dd class="m0">
                                                <textarea name="addendum" id="addendum" cols="15" rows="5" class="form-control m0 h-auto fs14 text-left"> {{ trans('attributes.business_plan.plan_19') }}</textarea>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
        ...
        @include('backend.preview_print.business_plan_print_add')
        <form id="form-condition-2" action="{{ route(USER_PROPERTY_BUSINESS_PLAN_CREATE, $property['id']) }}" method="GET">
            <input type="hidden" name="screen" value="{{ $optionUrl['screen'] }}" readonly>
            <input type="hidden" name="option_paginate" value="{{ $optionUrl['perPage'] }}" readonly>
