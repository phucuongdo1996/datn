        ...
        <table class="table table-bordered">
                    ...
                    <div class="row d-block p20l">
                        @foreach($specialties as $value)
                            <label class="container-input fs14 fw-bold width-fit-content">
                                <input type="checkbox" class="pointer profile-setting checkbox-specialty cus-checkbox" value="{{ $value['id'] }}" name="specialty[]"
                ...
                <td>
                    <div class="row p20l">
                        ...
                        <div class="col-9 col-md-4 p0l">
                            <input type="text" name="person_charge_last_name" class="form-control fs13 profile-setting" value="{{ $profile['person_charge_last_name'] }}"
                        ...
                        <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                            <input type="text" name="person_charge_first_name" class="form-control fs13 profile-setting" value="{{ $profile['person_charge_first_name'] }}"
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        ...
                        <div class="col-9 col-md-4 p0l">
                            <input type="text" name="person_charge_last_name_kana" class="form-control fs13 profile-setting"
                                   value="{{ $profile['person_charge_last_name_kana'] }}" placeholder="{{ __('attributes.profile.body.place_holder.kana_last_name') }}">
                        ...
                        <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                            <input type="text" name="person_charge_first_name_kana" class="form-control fs13 profile-setting"
                                   value="{{ $profile['person_charge_first_name_kana'] }}" placeholder="{{ __('attributes.profile.body.place_holder.kana_first_name') }}">
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l p0r">
                            <input type="text" name="email" value="{{ $profile['email'] }}" class="form-control col-10 fs13 profile-setting">
                        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l p0r">
                            <input type="text" name="business_name" class="form-control col-10 fs13 profile-setting not-required"
                                   value="{{ $profile['business_name'] }}" placeholder="{{ __('attributes.profile.body.place_holder.name_trademark') }}">
                        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l p0r">
                            <input type="text" name="website_business_name" class="form-control col-10 fs13 profile-setting"
                                   value="{{ $profile['website_business_name'] }}" placeholder="{{ __('attributes.profile.body.place_holder.web') }}">
                        </div>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-10 col-md-5 p0l p0r">
                            <input type="text" name="company_name" class="form-control fs13 profile-setting"
                                   value="{{ $profile['company_name'] }}" placeholder="{{ __('attributes.profile.body.place_holder.company') }}">
                            <p class="error-message p5t m0" data-error="company_name"></p>
                        </div>
                        <span class="col-10 d-none d-md-block col-md-1 text-center fs20">/</span>
                        <div class="col-10 col-md-5 p0l p0r">
                            <input type="text" name="division" class="form-control fs13 profile-setting"
                                   value="{{ $profile['division'] }}" placeholder="{{ __('attributes.profile.body.place_holder.division') }}">
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <label class="col-2 col-md-1 text-left lh3 p0">{{ __('attributes.profile.body.content.last_name') }}</label>
                        <div class="col-9 col-md-4 p0l">
                            <input type="text" class="form-control fs13 profile-setting" name="company_representative_last_name"
                        ...
                        <label class="col-2 col-md-1 text-left text-md-center lh3 p0">{{ __('attributes.profile.body.content.first_name') }}</label>
                        <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                            <input type="text" class="form-control fs13 profile-setting" name="company_representative_first_name"
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l">
                            <input type="text" name="phone" class="form-control col-11 col-md-5 fs13 profile-setting"
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l">
                            <input type="text" name="zip_code" class="form-control col-11 col-md-5 fs13 profile-setting zip-code"
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l">
                            <input type="text" name="address_district" class="form-control col-11 col-md-5 fs13 profile-setting"
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <input type="text" name="address_town" class="form-control col-11 fs13 profile-setting" placeholder="{{ __('attributes.profile.body.place_holder.address_2') }}"
                               value="{{ $profile['address_town'] }}">
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <input type="text" name="address_building" class="form-control col-11 fs13 profile-setting not-required"
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <div class="col-md-12 p0l p0r">
                            <input type="text" name="website_business_name_other" class="form-control col-11 fs13 profile-setting not-required"
                                   value="{{ $profile['website_business_name_other'] }}" placeholder="{{ __('attributes.profile.body.place_holder.other_web') }}">
                        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="row p20l">
                        <textarea name="introduction" class="form-control col-11 profile-setting not-required" rows="7">{{ $profile['introduction'] }}</textarea>
