<thead>
    <tr>
        ...
        <th>{{ __('attributes.profile.body.label.information_from_CYARea') }}</th>
...
<tbody>
    @foreach( $users as $key => $user)
        ...
        <tr>
            ...
            <td>{{ $user['profile']['birthday'] ? dateTimeFormat($user['profile']['birthday']) : '' }}</td>
            ...
            <td>{{ NOTIFICATION[$user['profile']['notification']] }}</td>
