                        ...
                        <div class="dropdown dropdown-none-icon">
                            ...
                            <div class="dropdown-menu dropdown-menu-right set-scrollbar">
                                @foreach($listProperty as $item)
                                    <a href="{{ route(ADMIN_PROPERTY_EDIT, $item['id']) }}" class="dropdown-item find-property pointer">{{ $item['house_name'] }}</a>
                                @endforeach
                            </div>
                    ...
                    <div class="col-12 col-lg-6 p0 p15lr">
                        <div class="item-block-property m30t p25">
                            <div class="row m-0">
                                ...
                                <div class="col-5 col-sm-3 col-md-12 col-xl-3 cus-col-image m5b res_mobile">
                                    @if($property['avatar_thumbnail'] != null)
                                        <div id="image-avatar" class="disable-field avatar dropzone pointer m0 br0">
                                            <div class="dz-default dz-message">
                                                <img src="{{ asset('storage/'. FOLDER_IMAGES_PROPERTY .'/'.$property['avatar_thumbnail']) }}" class="property-img-view-custom">
                                            </div>
                                        </div>
                                    @else
                                        <div id="image-avatar" class="disable-field avatar dropzone pointer m0 br0">
                            ...
                            @if(in_array($userOwner->role, [BROKER, EXPERT]))
                                <div class="row m-0 p15t fs14">
                                    <div class="col-12 col-xl-12">
                                        <span>{{ trans('attributes.register_info.item_block.label.proprietor') }}</span>
                                        <input type="text" class="form-control m5t m5b fs14" name="proprietor" value="{{ $property['proprietor'] ?? "" }}">
                            ...
                            <div class="row m-0 p5t fs14">
                                ...
                                <div class="col-12 col-xl-4 p5t-mobile">
                                    ...
                                    <input type="text" class="form-control m5t m5b date-time fs14 text-center"
                                           name="receive_house_date" value="{{ $property['receive_house_date'] ? date("Y/m/d", strtotime($property['receive_house_date'])) : '' }}">
                                ...
                                <div class="col-12 col-xl-4 p5t-mobile">
                                    ...
                                    <input type="text" class="form-control m5t m5b date-time fs14 text-center"
                                           name="loan_date" value="{{ $property['loan_date'] ? date("Y/m/d", strtotime($property['loan_date'])) : '' }}">
                            ...
                            <div class="row m-0 p5t fs14">
                                <div class="col-12 col-xl-6 res_mobile">
                                    ...
                                    <input type="hidden" value="{{ $property['loan_bank_name'] ?? "" }}" id="loan-bank-name">
                                ...
                                <div class="col-12 col-xl-6 p5t-mobile">
                                    ...
                                    <input type="hidden" value="{{ $property['bank_branch_name'] ?? "" }}" id="bank-branch-name">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control m5t m5b money-receive-house fs14 text-right convert-data"
                                                   name="money_receive_house" value="{{ $property['money_receive_house'] ?? '' }}">
                                        </div>
                                        ...
                                        <div class="col-10">
                                            ...
                                            <select name="contract_loan_period" class="form-control m5t m5b fs14">
                                                @foreach($year as $key => $value)
                                                    <option value="{{ $key + 1 }}"
                                                    @if($key + 1 == $property['contract_loan_period'])
                                                        {{ 'selected' }}
                                                        @endif
                                                    >{{ $value }}</option>
                                                @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control m5t m5b fs14 text-right convert-number-double-decimal"
                                                   name="interest_rate" value="{{ $property['interest_rate'] ?? '0.00' }}">
                                        </div>
                                        <div class="col-2 centered p0r text-flex-end">
                        ...
                        <div class="item-block-property m30t p25 fs14">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14"
                                           name="house_name" value="{{ $property['house_name'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 zip-code"
                                           name="zip_code" value="{{ $property['zip_code'] ?? '' }}">
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="address_city" class="form-control m5t m5b fs14 address-city">
                                        ...
                                        @foreach($prefectures as $key => $prefecture)
                                            ...
                                            @if($prefecture == $property['address_city'])
                                                {{ 'selected' }}
                                                @endif
                                            >{{ $prefecture }}</option>
                                        @endforeach
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    ...
                                    @endforeach
                                    <input type="hidden" class="edit-address-district" value="{{ $property['address_district'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b address-town fs14"
                                           name="address_town" value="{{ $property['address_town'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14"
                                           name="apartment_number" value="{{ $property['apartment_number'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14"
                                           name="room_number" value="{{ $property['room_number'] ?? '' }}">
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="real_estate_type_id" class="form-control m5t m5b real-estate-type " id="read-estate-type">
                                        ...
                                        @foreach($listReadEstateType as $readEstateType)
                                            ...
                                            @if($readEstateType['id'] == $property['real_estate_type_id'])
                                                {{ 'selected' }}
                                                @endif
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                @foreach($listDetailReadEstateType as $detailReadEstateType)
                                    <input type="hidden" class="detail-real-estate-type-id-{{$detailReadEstateType['real_estate_type_id']}}" value="{{ $detailReadEstateType['id'] }}" data-name="{{ $detailReadEstateType['name'] }}">
                                @endforeach
                                <input type="hidden" class="edit-detail-real-estate" value="{{ $property['detail_real_estate_type']['id'] }}">
                                <div class="col-12 col-xl-7">
                            ...
                            <div id="div-main_application" class="row m-0 p10t align-items-center pcH @if($property['real_estate_type_id'] == NUMBER_MAIN_APPLICATION) display-flex @endif">
                                <div class="col-12 col-xl-5">
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="main_application" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach(MAIN_APPLICATION as $key => $value)
                                            <option value="{{ $key }}"
                                            @if($key == $property['main_application'])
                                                {{ 'selected' }}
                                                @endif
                                            >{{ $value }}</option>
                                        @endforeach
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="house_material_id" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach($listHouseMaterial as $houseMaterial)
                                            ...
                                            @if($houseMaterial['id'] == $property['house_material_id'])
                                                {{ 'selected' }}
                                                @endif
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="house_roof_type_id" class="form-control m5t m5b w-40 fs14">
                                        ...
                                        @foreach($listHouseRoofType as $houseRoofType)
                                            ...
                                            @if($houseRoofType['id'] == $property['house_roof_type_id'])
                                                {{ 'selected' }}
                                                @endif
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b w-45 d-inline-block fs14 text-right convert-number-double-decimal"
                                           name="ground_area" value="{{ $property['ground_area'] ?? '0.00' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b w-45 d-inline-block fs14 text-right convert-number-double-decimal"
                                           name="total_area_floors" value="{{ $property['total_area_floors'] ?? '0.00' }}">
                                    <span class="m10l">{{ __('attributes.common.square_meters') }}</span>
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b date-time text-center fs14"
                                           name="construction_time" value="{{ $property['construction_time'] ? date("Y/m/d", strtotime($property['construction_time'])) : '' }}">
                        ...
                        <div class="item-block-property m30t p25 fs14">
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="land_right_id" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach($listLandRight as $landRight)
                                            ...
                                            @if($landRight['id'] == $property['land_right_id'])
                                                {{ 'selected' }}
                                                @endif
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="building_right_id" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach($listBuildingRight as $buildingRight)
                                            ...
                                            @if($buildingRight['id'] == $property['building_right_id'])
                                                {{ 'selected' }}
                                                @endif
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b text-center fs14 convert-data"
                                           name="total_tenants" value="{{ $property['total_tenants'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b w-45 d-inline-block rental-percentage fs14 text-right convert-number-double-decimal"
                                           name="area_may_rent" value="{{ $property['area_may_rent'] ?? '0.00' }}">
                                    <span class="m10l">{{ __('attributes.common.square_meters') }}</span>
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b w-90 d-inline-block fs14 text-right convert-data" name="deposits" value="{{ $property['deposits'] ?? '' }}"><span class="unit-yen">{{ __('attributes.common.yen') }}</span>
                        ...
                        <div class="item-block-property m30t p25 fs14">
                                ...
                                <div class="col-12 col-xl-7">
                                    <select name="type_rental_id" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach($listTypeRental as $typeRental)
                                            ...
                                            @if($typeRental['id'] == $property['type_rental_id'])
                                                {{ 'selected' }}
                                                @endif
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b w-45 d-inline-block fs14 text-right convert-number-double-decimal"
                                           name="area_rent" value="{{ $property['area_rent'] ?? '0.00' }}">
                                    <span class="m10l">{{ __('attributes.common.square_meters') }}</span>
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b date-time text-center fs14"
                                           name="rental_period_from" value="{{ $property['rental_period_from'] ? date("Y/m/d", strtotime($property['rental_period_from'])) : '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b date-time text-center fs14"
                                           name="rental_period_to" value="{{ $property['rental_period_to'] ? date("Y/m/d", strtotime($property['rental_period_to'])) : '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b date-time text-center fs14"
                                           name="date_lease" value="{{ $property['date_lease'] ? date("Y/m/d", strtotime($property['date_lease'])) : '' }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 text-center"
                                           name="deposit_host" value="{{ $property['deposit_host'] == "" ? trans('attributes.common.no_stipulation') : $property['deposit_host'] }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 text-center"
                                           name="prize_money" value="{{ $property['prize_money'] == "" ? trans('attributes.common.no_stipulation') : $property['prize_money'] }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 text-center"
                                           name="room_cede_fee" value="{{ $property['room_cede_fee'] == "" ? trans('attributes.common.no_stipulation') : $property['room_cede_fee'] }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 text-center"
                                           name="fee_rebuild_rented_house" value="{{ $property['fee_rebuild_rented_house'] == "" ? trans('attributes.common.no_stipulation') : $property['fee_rebuild_rented_house'] }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b fs14 text-center"
                                           name="contract_update_fee" value="{{ $property['contract_update_fee'] == "" ? trans('attributes.common.no_stipulation') : $property['contract_update_fee'] }}">
                            ...
                            <div class="row m-0 p10t d-flex align-items-center">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b text-center fs14"
                                           name="notes" value="{{ $property['notes'] ?? 'ー' }}">
                    ...
                    <div class="col-12 col-lg-6 p0 p15lr">
                                ...
                                <div class="col-6 col-md-4">
                                    ...
                                    <select id="date_year_registration_revenue" name="date_year_registration_revenue" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach($dateYear as $year)
                                            ...
                                            @if($year == $property['date_year_registration_revenue'])
                                                {{ 'selected' }}
                                                @endif
                                            >{{ $year }}年</option>
                                        @endforeach
                                ...
                                <div class="col-6 col-md-4">
                                    <select id="date_month_registration_revenue" name="date_month_registration_revenue" class="form-control m5t m5b fs14">
                                        ...
                                        @foreach(MONTH as $key => $month)
                                            ...
                                            @if($key == $property['date_month_registration_revenue'])
                                                {{ 'selected' }}
                                                @endif
                                            >{{ $month }}</option>
                                        @endforeach
                        ...
                        <div class="item-block-property m30t p25 fs14">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    @if($property['real_estate_type_id'] == FLAG_TEN || $property['real_estate_type_id'] == FLAG_NINE)
                                        <input type="text" class="form-control m5t m5b revenue_land_taxes revenue-land-taxes operating-revenue fs14 text-right convert-data" min="0" name="revenue_land_taxes" value="{{ $property['revenue_land_taxes'] ?? '0' }}">
                                    @else
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_room_rentals" value="{{ $property['revenue_room_rentals'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_service_charges" value="{{ $property['revenue_service_charges'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_utilities" value="{{ $property['revenue_utilities'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_car_deposits" value="{{ $property['revenue_car_deposits'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="turnover_revenue" value="{{ $property['turnover_revenue'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_contract_update_fee" value="{{ $property['revenue_contract_update_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="revenue_other" value="{{ $property['revenue_other'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-revenue fs14 text-right convert-data" min="0"
                                           name="bad_debt" value="{{ $property['bad_debt'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" disabled class="disable-field form-control m5t m5b fw-bold operating_expenses total-revenue fs18 text-right convert-data"
                                           name="total_revenue" value="{{ $property['total_revenue'] ?? '' }}">
                        ...
                        <div class="item-block-property m30t p25 fs14">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="maintenance_management_fee" value="{{ $property['maintenance_management_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="electricity_gas_charges" value="{{ $property['electricity_gas_charges'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="repair_fee" value="{{ $property['repair_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="recovery_costs" value="{{ $property['recovery_costs'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="property_management_fee" value="{{ $property['property_management_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="find_tenant_fee" value="{{ $property['find_tenant_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="loss_insurance" value="{{ $property['loss_insurance'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="land_rental_fee" value="{{ $property['land_rental_fee'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class="form-control m5t m5b operating-fee fs14 text-right convert-data"
                                           name="other_costs" value="{{ $property['other_costs'] ?? '' }}">
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" disabled class="disable-field form-control m5t m5b fw-bold operating_expenses total-cost fs18 text-right convert-data"
                                           name="total_cost" value="{{ $property['total_cost'] ?? '' }}">
                        ...
                        <div class="item-block-property m30t p25 fs14">
                            <div class="row m-0">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="hidden" value="{{ $property['operating_expenses'] ?? 0 }}" disabled class="disable-field form-control m5t m5b fw-bold operating-expenses fs18 text-right convert-data"
                                           name="operating_expenses">
                                    <input id="operating-expenses" type="text" value="{{ $property['operating_expenses'] ? numberFormatWithUnit($property['operating_expenses'], ' 円') : '0 円' }}" disabled class="disable-field form-control m5t m5b fw-bold fs18 text-right">
                        ...
                        <div class="item-block-property m30t p25 fs14">
                            <div class="row m-0 p5t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="text" class=" form-control m5t m5b fw-bold fs18 w-90 d-inline-block rental-percentage text-right convert-number-double-decimal" name="area_rental_operating" value="{{ $property['area_rental_operating'] ?? '0.00' }}"><span class="unit-yen">{{ __('attributes.common.square_meters') }}</span>
                            ...
                            <div class="row m-0 p10t">
                                ...
                                <div class="col-12 col-xl-7">
                                    <input type="hidden" disabled value="{{ $property['rental_percentage'] ?? '0.00' }}" class="disable-field form-control m5t m5b fw-bold fs18 property-rental-percentage convert-data text-right" name="rental_percentage">
                                    <input id="rental-percentage" type="text" disabled value="{{ $property['rental_percentage'] ? numberFormatWithUnit($property['rental_percentage'], ' %', FLAG_TWO) : '0.00 %' }}" class="disable-field form-control m5t m5b fw-bold fs18 text-right">
                        ...
                        <div id="simulation-result" class="item-block-property m30t p33t p25r p35b p25l">
                            <div class="row m0">
                                <div class="col-12 text-left m10b">
                                    ...
                                    <p class="highcharts-description fs7 highcharts-note m15l" style="display: none">
