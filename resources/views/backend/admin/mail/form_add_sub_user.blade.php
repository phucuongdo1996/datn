<div>{{ $mainUser['profile']['person_charge_last_name'].$mainUser['profile']['person_charge_first_name'].__('attributes.invite_user.gender') }}</div>
<br>
<div>{{ __('mail-attributes.admin_add_sub_user.line_1') }}</div>
