                ...
                <div class="card">
                    <div class="card-body">
                        <form id="form-data-profile">
                            <input type="hidden" class="parent-id" value="{{$userId}}">
                            <div class="head">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l p20r">
                                                ...
                                                <input id="nick_name" type="text" name="nick_name" class="form-control profile-setting">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                ...
                                                <div class="col-9 col-md-4 p0l">
                                                    <input type="text" name="person_charge_last_name" class="form-control fs13" placeholder="{{ trans('attributes.profile.body.place_holder.last_name') }}">
                                                ...
                                                <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                                    <input type="text" name="person_charge_first_name" class="form-control fs13" placeholder="{{ trans('attributes.profile.body.place_holder.first_name') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                ...
                                                <div class="col-9 col-md-4 p0l">
                                                    <input type="text" name="person_charge_last_name_kana" class="form-control fs13" placeholder="{{ trans('attributes.profile.body.place_holder.kana_last_name') }}">
                                                ...
                                                <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                                    <input type="text" name="person_charge_first_name_kana" class="form-control fs13" placeholder="{{ trans('attributes.profile.body.place_holder.kana_first_name') }}">
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <select name="gender" class="form-control col-10 col-md-2 m5b fs13">
                                                    <option value="0">{{ trans('attributes.common.male') }}</option>
                                                    <option value="1">{{ trans('attributes.common.female') }}</option>
                                                </select>
                                                ...
                                                <div class="col-10 col-md-3 p0l p0r">
                                                    <input type="text" name="birthday" id="date-picker" class="form-control fs13" value="1980/01/01">
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <div class="col-10 col-md-8 p0l p0r">
                                                    <input type="text" name="email" value="" class="form-control fs13" placeholder="abcde@sample.jp">
                                                </div>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <div class="col-10 col-md-5 p0l p0r">
                                                    <input type="text" name="company_name" class="form-control fs13 not-required" placeholder="{{ trans('attributes.profile.body.place_holder.company') }}">
                                                    <p class="error-message p5t m0" data-error="company_name"></p>
                                                </div>
                                                <span class="col-10 col-md-1 d-none d-md-block text-center fs20">/</span>
                                                <div class="col-10 col-md-5 p0l p0r">
                                                    <input type="text" name="division" class="form-control fs13 not-required" placeholder="{{ trans('attributes.profile.body.place_holder.division') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <label class="col-2 col-md-1 text-left lh3 p0">{{ trans('attributes.profile.body.content.last_name') }}</label>
                                                <div class="col-9 col-md-4 p0l">
                                                    <input type="text" class="form-control fs13 not-required" name="company_representative_last_name" placeholder="{{ trans('attributes.profile.body.place_holder.last_name') }}">
                                                    <p class="error-message p5t m0" data-error="company_representative_last_name"></p>
                                                </div>
                                                <label class="col-2 col-md-1 text-left text-md-center p0 lh3">{{ trans('attributes.profile.body.content.first_name') }}</label>
                                                <div class="col-9 col-md-4 p0r p0l-under-md input-md-pr">
                                                    <input type="text" class="form-control fs13 not-required" name="company_representative_first_name" placeholder="{{ trans('attributes.profile.body.place_holder.first_name') }}">
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <div class="col-md-12 p0l">
                                                    <input type="text" name="phone" class="form-control col-11 col-md-6 fs13" placeholder="{{ trans('attributes.profile.body.place_holder.phone') }}">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <div class="col-md-12 p0l">
                                                    <input type="text" name="zip_code" class="form-control col-11 col-md-6 fs13 zip-code" placeholder="{{ trans('attributes.profile.body.place_holder.ZIP_code') }}">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <div class="col-md-12 p0l">
                                                    <input type="text" name="address_district" class="form-control col-11 col-md-6 fs13" placeholder="{{ trans('attributes.profile.body.place_holder.address_district') }}">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <input type="text" class="form-control col-11 fs13" name="address_town" placeholder="{{ trans('attributes.profile.body.place_holder.address_2') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p20l">
                                                <input type="text" class="form-control col-11 not-required fs13" name="address_building" placeholder="{{ trans('attributes.profile.body.place_holder.address_3') }}">
                            ...
                            <div class="row p15r p15l">
                                <div class="col-12 text-center">
                                    <button type="button" id="import-info" class="btn border-0 custom-top-btn-primary admin-add">{{ trans('attributes.profile.footer.button_save') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
