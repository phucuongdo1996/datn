    ...
    <div class="product-item-horizontal" style="padding: 10px;">
        <div class="d-flex position-relative h-100">
            <div class="col-4 d-flex overflow-hidden" style="width: 100%; height: 110px; background-color: black">
                <img class="zoom-hover object-fit-contain" src="{{ asset(getImageUrl($item)) }}" alt="">
            </div>
            <div class="col-8 row m0 p10lr">
                <div class="col-12 p10t p10b font-weight-bold">{{ mb_strimwidth($item['product_base']['name'], 0, 25, '...') }}</div>
                ...
                <div class="col-12 product-price p10t p10b font-weight-bold text-blue text-center" style="height: fit-content">$ {{ number_format($item['price']) }}</div>
            </div>
        </div>
    </div>
</a>
